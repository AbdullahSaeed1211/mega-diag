# Full Ecosystem — Master Revenue + Customer Journey

> Single source of truth — the complete `flowchart TD` rendered below. Individual stage files in [`processes/`](processes/) are extracted from this file.
...
---
*Source synced from the original Mermaid definition provided via issue.*
